...
var cnItems = {
    ...
    "\"<= Go outside\"": "\"<= 出门\"",
    "\"Crash down and take a nap\"": "\“躺倒并小睡一会儿\”",
    ...
    "Sandals": "凉鞋",
    "This fell out of a dummy when you punched it to death": "当你一拳打死一个假人，它从假人身上掉了下来",
    ...
    "A Sando-gasa is made by weaving straw together. Great for boys who are too embarrassed to use a parasol": "草帽是用稻草编织而成的。 非常适合那些不好意思使用遮阳伞的男孩",
    ...
    "The man then proceeds to fidget in unrest": "然后，该男子开始不安地躁动。",
    ...
    "Ability to absorb Air Ki and assimilate it within your body": "能够吸收空气并将其吸收到体内",
    "Air Absorption": "空气吸收",
    "Provides minor protection from air-based attacks": "对空气攻击提供轻微的保护",
    ...
    "Grants invulnerability to poisons for a few hours": "使几个小时内对毒药无敌",
    "Hammer Mastery": "锤子精通",
    ...
    "Old worthless blade, forgotten for ages. It falls apart as you attempt to swing it": "破旧的毫无价值的刀片，被遗忘了多年。当你试图挥舞它时它会崩裂",
    "Patting": "拍拍",
    ...
    "\"Third-Rate Shopper\"": "\"三流购物者\"",
    "\"Village Militia\"": "\“乡村民兵\”",
    "You feel bad inside": "你感到胃里翻江倒海",
    "\"Rotten Illustration\"": "腐烂的画",
    "Found this within old bushery, it looks like a drawing of something in charcoal": "在古老的灌木丛中发现了这个，它看起来像是用木炭画的。",
    "You scavenged some goods from this forest area": "你从森林的这个地区搜刮到了一些物品",
    "\"Accept the reward\"": "接收奖励",
    "Well done! Hunting down animals and stockpiling food that way is always a good precaution. Cooking or drying raw meat is generally a better idea than consuming it raw, give that a piece of mind if you\'re not sure what to do with the stuff you have.<br>All in all, you deserve a reward": "干得好! 猎取动物并储存食物总是一个很好的准备措施。如果你不确定该如何处理你的肉，煮熟或晒干生肉通常比生吃要好，总之，这是你应得的奖励",
    "You feel safer": "你感觉更安全了",
    "Life Drop": "生命液滴",
...
var cnPrefix = {
    ...
    "The cone was empty..": "这个松果是空的...",
    "\"Sell Everything\"": "卖出所有",
    "\"Sell 1 piece\"": "卖出1份",
    "\"Sell 5 piece\"": "卖出5份",
    "\"Sell 10 piece\"": "卖出10份",
    "gel": "凝胶",
